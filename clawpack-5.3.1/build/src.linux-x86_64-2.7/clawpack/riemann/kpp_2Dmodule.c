...
static PyObject *kpp_2D_error;
static PyObject *kpp_2D_module;
...
#define CHECKSCALAR(check,tcheck,name,show,var)\
  if (!(check)) {\
    ...
    PyErr_SetString(kpp_2D_error,errstring);\
    /*goto capi_fail;*/\
  } else 
#ifdef DEBUGCFUNCS
...
/* See f2py2e/rules.py */
extern void F_FUNC(rpn2,RPN2)(int*,int*,int*,int*,int*,int*,int*,double*,double*,float*,float*,double*,double*,double*,double*);
...
/************************************ rpn2 ************************************/
static char doc_f2py_rout_kpp_2D_rpn2[] = "\
...
/* extern void F_FUNC(rpn2,RPN2)(int*,int*,int*,int*,int*,int*,int*,double*,double*,float*,float*,double*,double*,double*,double*); */
static PyObject *f2py_rout_kpp_2D_rpn2(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*,int*,int*,int*,int*,int*,int*,double*,double*,float*,float*,double*,double*,double*,double*)) {
...
/*frompyobj*/
  /* Processing variable auxl */
    f2py_success = float_from_pyobj(&auxl,auxl_capi,"kpp_2D.rpn2() 8th argument (auxl) can't be converted to float");
  if (f2py_success) {
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"kpp_2D.rpn2() 4th argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable auxr */
    f2py_success = float_from_pyobj(&auxr,auxr_capi,"kpp_2D.rpn2() 9th argument (auxr) can't be converted to float");
  if (f2py_success) {
  /* Processing variable maux */
    f2py_success = int_from_pyobj(&maux,maux_capi,"kpp_2D.rpn2() 3rd argument (maux) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ixy */
    f2py_success = int_from_pyobj(&ixy,ixy_capi,"kpp_2D.rpn2() 1st argument (ixy) can't be converted to int");
  if (f2py_success) {
  /* Processing variable maxm */
    f2py_success = int_from_pyobj(&maxm,maxm_capi,"kpp_2D.rpn2() 2nd argument (maxm) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"kpp_2D.rpn2() 5th argument (mx) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(kpp_2D_error,"failed in converting 6th argument `ql' of kpp_2D.rpn2 to C/Fortran array" );
  } else {
    ql = (double *)(capi_ql_tmp->data);

  /* Processing variable meqn */
  if (meqn_capi == Py_None) meqn = shape(ql,0); else
    f2py_success = int_from_pyobj(&meqn,meqn_capi,"kpp_2D.rpn2() 1st keyword (meqn) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_wave_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(kpp_2D_error,"failed in converting 10th argument `wave' of kpp_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_amdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(kpp_2D_error,"failed in converting 12nd argument `amdq' of kpp_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_apdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(kpp_2D_error,"failed in converting 13rd argument `apdq' of kpp_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(kpp_2D_error,"failed in converting 7th argument `qr' of kpp_2D.rpn2 to C/Fortran array" );
  } else {
    qr = (double *)(capi_qr_tmp->data);

  /* Processing variable mwaves */
  if (mwaves_capi == Py_None) mwaves = shape(wave,1); else
    f2py_success = int_from_pyobj(&mwaves,mwaves_capi,"kpp_2D.rpn2() 2nd keyword (mwaves) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_s_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(kpp_2D_error,"failed in converting 11st argument `s' of kpp_2D.rpn2 to C/Fortran array" );
  } else {
...
/************************************ rpt2 ************************************/
static char doc_f2py_rout_kpp_2D_rpt2[] = "\
...
"bpasdq : input float";
/* extern void F_FUNC(rpt2,RPT2)(int*,int*,int*,int*,int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*); */
static PyObject *f2py_rout_kpp_2D_rpt2(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  /* Processing variable bmasdq */
    f2py_success = double_from_pyobj(&bmasdq,bmasdq_capi,"kpp_2D.rpt2() 15th argument (bmasdq) can't be converted to double");
  if (f2py_success) {
  /* Processing variable bpasdq */
    f2py_success = double_from_pyobj(&bpasdq,bpasdq_capi,"kpp_2D.rpt2() 16th argument (bpasdq) can't be converted to double");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"kpp_2D.rpt2() 8th argument (mx) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"kpp_2D.rpt2() 7th argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable aux2 */
    f2py_success = double_from_pyobj(&aux2,aux2_capi,"kpp_2D.rpt2() 12nd argument (aux2) can't be converted to double");
  if (f2py_success) {
  /* Processing variable aux3 */
    f2py_success = double_from_pyobj(&aux3,aux3_capi,"kpp_2D.rpt2() 13rd argument (aux3) can't be converted to double");
  if (f2py_success) {
  /* Processing variable aux1 */
    f2py_success = double_from_pyobj(&aux1,aux1_capi,"kpp_2D.rpt2() 11st argument (aux1) can't be converted to double");
  if (f2py_success) {
  /* Processing variable qr */
    f2py_success = double_from_pyobj(&qr,qr_capi,"kpp_2D.rpt2() 10th argument (qr) can't be converted to double");
  if (f2py_success) {
  /* Processing variable maux */
    f2py_success = int_from_pyobj(&maux,maux_capi,"kpp_2D.rpt2() 6th argument (maux) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mwaves */
    f2py_success = int_from_pyobj(&mwaves,mwaves_capi,"kpp_2D.rpt2() 5th argument (mwaves) can't be converted to int");
  if (f2py_success) {
  /* Processing variable meqn */
    f2py_success = int_from_pyobj(&meqn,meqn_capi,"kpp_2D.rpt2() 4th argument (meqn) can't be converted to int");
  if (f2py_success) {
  /* Processing variable imp */
    f2py_success = int_from_pyobj(&imp,imp_capi,"kpp_2D.rpt2() 2nd argument (imp) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ixy */
    f2py_success = int_from_pyobj(&ixy,ixy_capi,"kpp_2D.rpt2() 1st argument (ixy) can't be converted to int");
  if (f2py_success) {
  /* Processing variable maxm */
    f2py_success = int_from_pyobj(&maxm,maxm_capi,"kpp_2D.rpt2() 3rd argument (maxm) can't be converted to int");
  if (f2py_success) {
  /* Processing variable asdq */
    f2py_success = double_from_pyobj(&asdq,asdq_capi,"kpp_2D.rpt2() 14th argument (asdq) can't be converted to double");
  if (f2py_success) {
  /* Processing variable ql */
    f2py_success = double_from_pyobj(&ql,ql_capi,"kpp_2D.rpt2() 9th argument (ql) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_routine_defs[] = {
  {"rpn2",-1,{{-1}},0,(char *)F_FUNC(rpn2,RPN2),(f2py_init_func)f2py_rout_kpp_2D_rpn2,doc_f2py_rout_kpp_2D_rpn2},
  {"rpt2",-1,{{-1}},0,(char *)F_FUNC(rpt2,RPT2),(f2py_init_func)f2py_rout_kpp_2D_rpt2,doc_f2py_rout_kpp_2D_rpt2},
...
#if PY_VERSION_HEX >= 0x03000000
#define RETVAL m
PyMODINIT_FUNC PyInit_kpp_2D(void) {
#else
#define RETVAL
PyMODINIT_FUNC initkpp_2D(void) {
#endif
  int i;
  PyObject *m,*d, *s;
#if PY_VERSION_HEX >= 0x03000000
  m = kpp_2D_module = PyModule_Create(&moduledef);
#else
  m = kpp_2D_module = Py_InitModule("kpp_2D", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module kpp_2D (failed to import numpy)"); return RETVAL;}
...
#endif
    "This module 'kpp_2D' is auto-generated with f2py (version:2).\nFunctions:\n"
"  rpn2(ixy,maxm,maux,mbc,mx,ql,qr,auxl,auxr,wave,s,amdq,apdq,meqn=shape(ql,0),mwaves=shape(wave,1))\n"
"  rpt2(ixy,imp,maxm,meqn,mwaves,maux,mbc,mx,ql,qr,aux1,aux2,aux3,asdq,bmasdq,bpasdq)\n"
".");
  PyDict_SetItemString(d, "__doc__", s);
  kpp_2D_error = PyErr_NewException ("kpp_2D.error", NULL, NULL);
  Py_DECREF(s);
...
#ifdef F2PY_REPORT_ATEXIT
  if (! PyErr_Occurred())
    on_exit(f2py_report_on_exit,(void*)"kpp_2D");
#endif
