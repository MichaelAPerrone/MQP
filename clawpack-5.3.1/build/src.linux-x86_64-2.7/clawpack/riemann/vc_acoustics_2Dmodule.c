...
static PyObject *vc_acoustics_2D_error;
static PyObject *vc_acoustics_2D_module;
...
#define CHECKSCALAR(check,tcheck,name,show,var)\
  if (!(check)) {\
    ...
    PyErr_SetString(vc_acoustics_2D_error,errstring);\
    /*goto capi_fail;*/\
  } else 
#ifdef DEBUGCFUNCS
...
static int int_from_pyobj(int* v,PyObject *obj,const char *errmess) {
  ...
  }
  {
    ...
    if (err==NULL) err = vc_acoustics_2D_error;
...
/************************************ rpn2 ************************************/
static char doc_f2py_rout_vc_acoustics_2D_rpn2[] = "\
...
/* extern void F_FUNC(rpn2,RPN2)(int*,int*,int*,int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*); */
static PyObject *f2py_rout_vc_acoustics_2D_rpn2(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOO|OOO:vc_acoustics_2D.rpn2",\
...
/*frompyobj*/
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"vc_acoustics_2D.rpn2() 3rd argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ixy */
    f2py_success = int_from_pyobj(&ixy,ixy_capi,"vc_acoustics_2D.rpn2() 1st argument (ixy) can't be converted to int");
  if (f2py_success) {
  /* Processing variable maxm */
    f2py_success = int_from_pyobj(&maxm,maxm_capi,"vc_acoustics_2D.rpn2() 2nd argument (maxm) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"vc_acoustics_2D.rpn2() 4th argument (mx) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_auxl_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 7th argument `auxl' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 5th argument `ql' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
    ql = (double *)(capi_ql_tmp->data);

  /* Processing variable maux */
  if (maux_capi == Py_None) maux = shape(auxl,0); else
    f2py_success = int_from_pyobj(&maux,maux_capi,"vc_acoustics_2D.rpn2() 3rd keyword (maux) can't be converted to int");
  if (f2py_success) {
  ...
  if (meqn_capi == Py_None) meqn = shape(ql,0); else
    f2py_success = int_from_pyobj(&meqn,meqn_capi,"vc_acoustics_2D.rpn2() 1st keyword (meqn) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_auxr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 8th argument `auxr' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_wave_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 9th argument `wave' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_amdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 11st argument `amdq' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_apdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 12nd argument `apdq' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 6th argument `qr' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
    qr = (double *)(capi_qr_tmp->data);

  /* Processing variable mwaves */
  if (mwaves_capi == Py_None) mwaves = shape(wave,1); else
    f2py_success = int_from_pyobj(&mwaves,mwaves_capi,"vc_acoustics_2D.rpn2() 2nd keyword (mwaves) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_s_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 10th argument `s' of vc_acoustics_2D.rpn2 to C/Fortran array" );
  } else {
...
/************************************ rpt2 ************************************/
static char doc_f2py_rout_vc_acoustics_2D_rpt2[] = "\
...
/* extern void F_FUNC(rpt2,RPT2)(int*,int*,int*,int*,int*,int*,int*,int*,double*,double*,double*,double*,double*,double*,double*,double*); */
static PyObject *f2py_rout_vc_acoustics_2D_rpt2(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOOOO|OO:vc_acoustics_2D.rpt2",\
...
/*frompyobj*/
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"vc_acoustics_2D.rpt2() 5th argument (mbc) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mwaves */
    f2py_success = int_from_pyobj(&mwaves,mwaves_capi,"vc_acoustics_2D.rpt2() 4th argument (mwaves) can't be converted to int");
  if (f2py_success) {
  /* Processing variable imp */
    f2py_success = int_from_pyobj(&imp,imp_capi,"vc_acoustics_2D.rpt2() 2nd argument (imp) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ixy */
    f2py_success = int_from_pyobj(&ixy,ixy_capi,"vc_acoustics_2D.rpt2() 1st argument (ixy) can't be converted to int");
  if (f2py_success) {
  /* Processing variable maxm */
    f2py_success = int_from_pyobj(&maxm,maxm_capi,"vc_acoustics_2D.rpt2() 3rd argument (maxm) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"vc_acoustics_2D.rpt2() 6th argument (mx) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ql */
  ql_Dims[1]=maxm+mbc-(1-mbc)+1;
  capi_ql_intent |= F2PY_INTENT_IN;
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 7th argument `ql' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
    ql = (double *)(capi_ql_tmp->data);
  ...
  if (capi_aux1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 9th argument `aux1' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
    aux1 = (double *)(capi_aux1_tmp->data);

  /* Processing variable maux */
  if (maux_capi == Py_None) maux = shape(aux1,0); else
    f2py_success = int_from_pyobj(&maux,maux_capi,"vc_acoustics_2D.rpt2() 2nd keyword (maux) can't be converted to int");
  if (f2py_success) {
  CHECKSCALAR(shape(aux1,0)==maux,"shape(aux1,0)==maux","2nd keyword maux","rpt2:maux=%d",maux) {
  /* Processing variable meqn */
  if (meqn_capi == Py_None) meqn = shape(ql,0); else
    f2py_success = int_from_pyobj(&meqn,meqn_capi,"vc_acoustics_2D.rpt2() 1st keyword (meqn) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_bpasdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 14th argument `bpasdq' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
  ...
  if (capi_bmasdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 13rd argument `bmasdq' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
  ...
  if (capi_asdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 12nd argument `asdq' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
  ...
  if (capi_aux2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 10th argument `aux2' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
  ...
  if (capi_aux3_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 11st argument `aux3' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(vc_acoustics_2D_error,"failed in converting 8th argument `qr' of vc_acoustics_2D.rpt2 to C/Fortran array" );
  } else {
    qr = (double *)(capi_qr_tmp->data);
...
static FortranDataDef f2py_routine_defs[] = {
  {"rpn2",-1,{{-1}},0,(char *)F_FUNC(rpn2,RPN2),(f2py_init_func)f2py_rout_vc_acoustics_2D_rpn2,doc_f2py_rout_vc_acoustics_2D_rpn2},
  {"rpt2",-1,{{-1}},0,(char *)F_FUNC(rpt2,RPT2),(f2py_init_func)f2py_rout_vc_acoustics_2D_rpt2,doc_f2py_rout_vc_acoustics_2D_rpt2},
...
#if PY_VERSION_HEX >= 0x03000000
#define RETVAL m
PyMODINIT_FUNC PyInit_vc_acoustics_2D(void) {
#else
#define RETVAL
PyMODINIT_FUNC initvc_acoustics_2D(void) {
#endif
  int i;
  PyObject *m,*d, *s;
#if PY_VERSION_HEX >= 0x03000000
  m = vc_acoustics_2D_module = PyModule_Create(&moduledef);
#else
  m = vc_acoustics_2D_module = Py_InitModule("vc_acoustics_2D", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module vc_acoustics_2D (failed to import numpy)"); return RETVAL;}
...
#endif
    "This module 'vc_acoustics_2D' is auto-generated with f2py (version:2).\nFunctions:\n"
...
".");
  ...
  vc_acoustics_2D_error = PyErr_NewException ("vc_acoustics_2D.error", NULL, NULL);
  Py_DECREF(s);
...
#ifdef F2PY_REPORT_ATEXIT
  if (! PyErr_Occurred())
    on_exit(f2py_report_on_exit,(void*)"vc_acoustics_2D");
#endif
