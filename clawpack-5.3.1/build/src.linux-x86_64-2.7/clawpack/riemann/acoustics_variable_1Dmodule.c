...
"auxl : input rank-2 array('d') with bounds (2,maxm+mbc-(1-mbc)+1)\n"
"auxr : input rank-2 array('d') with bounds (2,maxm+mbc-(1-mbc)+1)\n"
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOOOOO|OO:acoustics_variable_1D.rp1",\
...
/*frompyobj*/
  /* Processing variable maux */
    f2py_success = int_from_pyobj(&maux,maux_capi,"acoustics_variable_1D.rp1() 2nd argument (maux) can't be converted to int");
  if (f2py_success) {
  /* Processing variable mbc */
    f2py_success = int_from_pyobj(&mbc,mbc_capi,"acoustics_variable_1D.rp1() 3rd argument (mbc) can't be converted to int");
  if (f2py_success) {
  ...
  /* Processing variable mx */
    f2py_success = int_from_pyobj(&mx,mx_capi,"acoustics_variable_1D.rp1() 4th argument (mx) can't be converted to int");
  if (f2py_success) {
  /* Processing variable auxl */
  auxl_Dims[0]=2,auxl_Dims[1]=maxm+mbc-(1-mbc)+1;
  ...
  if (capi_auxl_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 7th argument `auxl' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
    auxl = (double *)(capi_auxl_tmp->data);

  /* Processing variable auxr */
  auxr_Dims[0]=2,auxr_Dims[1]=maxm+mbc-(1-mbc)+1;
  ...
  if (capi_auxr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 8th argument `auxr' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_ql_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 5th argument `ql' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_wave_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 9th argument `wave' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_amdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 11st argument `amdq' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_apdq_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 12nd argument `apdq' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_qr_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 6th argument `qr' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
  ...
  if (capi_s_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(acoustics_variable_1D_error,"failed in converting 10th argument `s' of acoustics_variable_1D.rp1 to C/Fortran array" );
  } else {
