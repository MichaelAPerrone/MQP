...
#Based off of the PyClaw example code "shock bubble test"
#modified by Michael Alexander Perrone
r"""
Electromagnetic base wave in cylindrical symmetry coaxial cable
===============================================

Based off of the PyClaw example code "shock bubble test".
Modified by Michael Alexander Perrone for electromagnetic waves in coaxial cable
with cylindrical symmetry

Need to change the following math to suit the electromagnetic system to be used:
